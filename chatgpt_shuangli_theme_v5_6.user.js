// ==UserScript==
// @name         ChatGPT 霜璃 · 完整冰晶龙娘主题 V5.6
// @namespace    https://chatgpt.com/
// @version      5.6.0
// @description  网页版霜璃完整主题 V5.6：细节打磨版，统一悬停反馈、滚动反馈、代码表格引用样式、状态切换过渡，并重做霜璃设置面板细节。
// @match        https://chatgpt.com/*
// @match        https://www.chatgpt.com/*
// @run-at       document-end
// @grant        none
// @updateURL    https://raw.githubusercontent.com/z394547292-cloud/chatgpt-dragon-theme/main/chatgpt_shuangli_theme_v5_6.user.js
// @downloadURL  https://raw.githubusercontent.com/z394547292-cloud/chatgpt-dragon-theme/main/chatgpt_shuangli_theme_v5_6.user.js
// ==/UserScript==
...
(function () {
  ...
  function addSettings(){
    ...
    box.innerHTML=`
      <h3>❄ 霜璃主题设置</h3>
      <p>V5.6：细节打磨版。统一悬停与滚动反馈，细化代码、表格、引用样式，优化状态切换，并重做设置面板细节。</p>
  ...
  console.log('[霜璃主题] V5.6 loaded · detail polish');
})();