// ==UserScript==
// @name         ChatGPT 霜璃 · 完整冰晶龙娘主题 V4.6
// @namespace    https://chatgpt.com/
// @version      4.6.0
// @description  网页版霜璃完整主题：新增首页/对话/生成/完成场景系统，让背景、角色、光晕与氛围随页面状态联动。
// @match        https://chatgpt.com/*
// @match        https://www.chatgpt.com/*
// @run-at       document-end
// @grant        none
// @updateURL    https://raw.githubusercontent.com/z394547292-cloud/chatgpt-dragon-theme/main/chatgpt_shuangli_theme_v4_6.user.js
...
(function () {
  ...
  function addSettings(){
    ...
    box.innerHTML=`
      <h3>❄ 霜璃主题设置</h3>
      <p>V4.6：新增首页、对话、思考、输出、完成五类场景联动；设置会保存在浏览器本地。</p>
