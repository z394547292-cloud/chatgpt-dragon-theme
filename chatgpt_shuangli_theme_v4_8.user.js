// ==UserScript==
// @name         ChatGPT 霜璃 · 完整冰晶龙娘主题 V4.8
// @namespace    https://chatgpt.com/
// @version      4.8.0
// @description  网页版霜璃完整主题：加入待机/思考/输出/完成多状态角色系统，可为各状态使用独立霜璃图片并联动对白与光效。
// @match        https://chatgpt.com/*
// @match        https://www.chatgpt.com/*
// @run-at       document-end
// @grant        none
// @updateURL    https://raw.githubusercontent.com/z394547292-cloud/chatgpt-dragon-theme/main/chatgpt_shuangli_theme_v4_8.user.js
...
(function () {
  ...
  function openStateImageManager(){
    ...
    const row=(state,label)=>'<div style="display:flex;align-items:center;justify-content:space-between;padding:10px 0;border-top:1px solid rgba(135,126,160,.10)"><span>'+label+'</span><div style="display:flex;gap:6px"><button class="sl42-btn" data-set="'+state+'">导入</button><button class="sl42-btn" data-clear="'+state+'">清除</button></div></div>';
  ...
  function addSettings(){
    ...
    box.innerHTML=`
      <h3>❄ 霜璃主题设置</h3>
      <p>V4.8：新增待机、思考、输出、完成多状态角色系统；可分别导入不同霜璃图片。</p>
