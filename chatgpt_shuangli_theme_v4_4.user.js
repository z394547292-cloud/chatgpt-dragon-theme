// ==UserScript==
// @name         ChatGPT 霜璃 · 完整冰晶龙娘主题 V4.4
// @namespace    https://chatgpt.com/
// @version      4.4.0
// @description  网页版霜璃完整主题：统一侧栏、顶部、输入区、按钮、弹窗、代码工具栏与图标容器，延续 V4.3 状态联动。
// @match        https://chatgpt.com/*
// @match        https://www.chatgpt.com/*
// @run-at       document-end
// @grant        none
// @updateURL    https://raw.githubusercontent.com/z394547292-cloud/chatgpt-dragon-theme/main/chatgpt_shuangli_theme_v4_4.user.js
...
(function () {
  ...
  function addSettings(){
    ...
    box.innerHTML=`
      <h3>❄ 霜璃主题设置</h3>
      <p>V4.4：统一侧栏、顶部、输入区、按钮、弹窗与代码工具栏；设置会保存在浏览器本地。</p>
