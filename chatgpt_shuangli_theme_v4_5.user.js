// ==UserScript==
// @name         ChatGPT 霜璃 · 完整冰晶龙娘主题 V4.5
// @namespace    https://chatgpt.com/
// @version      4.5.0
// @description  网页版霜璃完整主题：加入霜璃徽记、雪晶角标、龙鳞分隔、专属输入区纹样与视觉识别层，延续 V4.4 细节统一。
// @match        https://chatgpt.com/*
// @match        https://www.chatgpt.com/*
// @run-at       document-end
// @grant        none
// @updateURL    https://raw.githubusercontent.com/z394547292-cloud/chatgpt-dragon-theme/main/chatgpt_shuangli_theme_v4_5.user.js
...
(function () {
  ...
  function addSettings(){
    ...
    box.innerHTML=`
      <h3>❄ 霜璃主题设置</h3>
      <p>V4.5：加入霜璃徽记、雪晶角标、龙鳞分隔与专属输入区纹样；设置会保存在浏览器本地。</p>
