...
// @run-at       document-end
// @grant        none
// @updateURL    https://raw.githubusercontent.com/z394547292-cloud/chatgpt-dragon-theme/main/chatgpt_shuangli_theme_v5_3.user.js
// @downloadURL  https://raw.githubusercontent.com/z394547292-cloud/chatgpt-dragon-theme/main/chatgpt_shuangli_theme_v5_3.user.js
// ==/UserScript==
...
(function () {
  ...
  function addHeroHitbox(){
    ...
    hit.addEventListener('click',()=>{
      if(get(KEY_INTERACTION,'1')==='0')return;
      const line=sl53ClickLines[Math.floor(Math.random()*sl53ClickLines.length)];
