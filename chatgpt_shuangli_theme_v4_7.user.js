// ==UserScript==
// @name         ChatGPT 霜璃 · 完整冰晶龙娘主题 V4.7
// @namespace    https://chatgpt.com/
// @version      4.7.0
// @description  网页版霜璃完整主题：加入首页欢迎构图、聊天景深、角色姿态变化与柔和场景过渡，强化完整作品感。
// @match        https://chatgpt.com/*
// @match        https://www.chatgpt.com/*
// @run-at       document-end
// @grant        none
// @updateURL    https://raw.githubusercontent.com/z394547292-cloud/chatgpt-dragon-theme/main/chatgpt_shuangli_theme_v4_7.user.js
...
(function () {
  ...
  function addSettings(){
    ...
    box.innerHTML=`
      <h3>❄ 霜璃主题设置</h3>
      <p>V4.7：首页欢迎构图、聊天景深、角色姿态变化与柔和场景过渡；设置会保存在浏览器本地。</p>
